      ...
      <div className="row">
        <div className="col s12 m4">
          <div className="icon-block">
            <h2 style={{ color: '#1ee9b6', fontSize: '48px' , textAlign: 'center' }} ><i className="material-icons" style={{fontSize: '2.5rem', display: 'flex', alignItems: 'center', justifyContent: 'center'}}>flash_on</i></h2>
        ...
        <div className="col s12 m4">
          <div className="icon-block">
            <h2 style={{ color: '#1ee9b6', fontSize: '50px' , textAlign: 'center' }} ><i className="material-icons" style={{display: 'flex', height: '3.5vh'}}>attach_payments</i></h2>
        ...
        <div className="col s12 m4">
          <div className="icon-block" >
            <h2 style={{ color: '#1ee9b6', fontSize: '48px' , textAlign: 'center' }} ><i className="material-icons" style={{fontSize: '2.5rem', display: 'flex', alignItems: 'center', justifyContent: 'center'}}>person</i>
            </h2>
